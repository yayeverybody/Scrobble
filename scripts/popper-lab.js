...
function resize(){const w=host.clientWidth||innerWidth,h=host.clientHeight||innerHeight;r.setSize(w,h,false);camera.aspect=w/h;const portrait=w<h;camera.position.set(portrait?12.9:7.6,portrait?14.4:8.5,portrait?17.8:10.5);camera.lookAt(0,-.15,0);camera.updateProjectionMatrix()}addEventListener('resize',resize);resize();
