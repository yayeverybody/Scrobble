...
function resize(){const w=host.clientWidth||innerWidth,h=host.clientHeight||innerHeight;r.setSize(w,h,false);camera.aspect=w/h;const portrait=w<h;camera.position.set(7.6,8.5,10.5);camera.lookAt(0,-.05,0);camera.zoom=portrait?0.34:1;camera.updateProjectionMatrix()}addEventListener('resize',resize);resize();
