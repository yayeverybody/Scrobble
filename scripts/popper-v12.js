...
// 28-space outer circuit plus four separate 4-space finish lanes. Coordinates are kept clear of the center popper.
const trackEl=document.getElementById('track');
const outer=[[8,8],[20,8],[32,8],[44,8],[56,8],[68,8],[80,8],[92,8],[92,22],[92,36],[92,50],[92,64],[92,78],[92,92],[80,92],[68,92],[56,92],[44,92],[32,92],[20,92],[8,92],[8,78],[8,64],[8,50],[8,36],[8,22],[8,15],[8,8]];
outer.forEach(([x,y],i)=>{const s=document.createElement('i');s.className='space'+([0,7,13,20].includes(i)?' start c'+[0,7,13,20].indexOf(i):'');s.style.left=x+'%';s.style.top=y+'%';trackEl.appendChild(s)});
const finishCoords=[[[20,25],[25,30],[30,35],[35,40]],[[80,25],[75,30],[70,35],[65,40]],[[80,75],[75,70],[70,65],[65,60]],[[20,75],[25,70],[30,65],[35,60]]];
